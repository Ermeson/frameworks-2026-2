...
- Head de Inovação — UniFAP
- Coordenador Geral de Pós-graduação — UNIFAP
- Consultor de Inovação e Transformação Digital — Sebrae
...
| 04 | Manipulação do DOM | [Acessar](https://ermeson.github.io/frameworks-2026-2/aula04/) |
| 05 | Introdução ao Vue.js | [Acessar](https://ermeson.github.io/frameworks-2026-2/aula05/) |
...
```
frameworks-2026-2/
├── aula01/            # Apresentação da disciplina
├── aula02/            # Introdução ao JavaScript
├── aula03/            # JavaScript: loops, arrays e funções
├── aula04/            # Manipulação do DOM
├── aula05/            # Introdução ao Vue.js
├── projetos/          # Projetos práticos desenvolvidos em aula
└── roteiro-avp1.md    # Roteiro de estudos para a AVP1
```

Cada pasta `aulaXX` contém um slide interativo (`index.html`) com o conteúdo apresentado em sala.
...
- Git e conta no [GitHub](https://github.com/)
